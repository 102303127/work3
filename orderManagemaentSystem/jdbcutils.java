...
public class jdbcutils {
    ...
    static {
        in = jdbcutils.class.getClassLoader().getResourceAsStream("db.properties");
    ...
    public static void orderNotFoundException(Connection conn,int orderId) throws SQLException, MyException {
        ResultSet rs;
        String queryOrderSql = "select count(*) from `order` where `orderId` = ?";
    ...
    public static void productNotFountException(Connection conn,int productId) throws SQLException, MyException {
        ResultSet rs;
        String queryOrderSql = "select count(*) from `product` where `productId` = ?";
